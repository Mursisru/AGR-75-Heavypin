...
{
    internal static class SledgepinMotors
    {
        ...
        {
            AppliedThrustN = SledgepinConstants.MotorThrustN;
            AppliedFuelKg = SledgepinConstants.MotorFuelKg;
            AppliedBurnS = SledgepinConstants.MotorBurnS;
            AppliedTopSpeedMps = SledgepinConstants.DesignTopSpeedMps;
            SledgepinPlugin.ModLog?.LogInfo(
                $"Sledgepin motor F={AppliedThrustN:F0}N fuel={AppliedFuelKg:F1}kg burn={AppliedBurnS:F1}s top={AppliedTopSpeedMps:F0} ({SledgepinConstants.DesignTopSpeedMach:F1}M)");
        }
        ...
        internal static void Apply(Missile missile)
        {
            ...
            MassField?.SetValue(missile, SledgepinConstants.LaunchMassKg);
            SledgepinWarhead.Apply(missile);
            if (missile.rb != null)
                missile.rb.mass = SledgepinConstants.LaunchMassKg;
