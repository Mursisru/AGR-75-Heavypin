...
namespace Sledgepin.Runtime
{
    ...
    internal sealed class SledgepinIrCold : MonoBehaviour
    {
        ...
        internal static void Ensure(Missile missile)
        {
            if (missile == null)
                return;
            if (missile.GetComponent<SledgepinIrCold>() == null)
                missile.gameObject.AddComponent<SledgepinIrCold>();
        }
        ...
        private void FixedUpdate()
        {
            ...
            StripIr(_missile);
            _cold = true;
            SledgepinPlugin.ModLog?.LogInfo("Sledgepin IR cold after burnout.");
        }
