...
namespace Sledgepin.Patches
{
    ...
    internal static class EncyclopediaAfterLoadPatch
    {
        ...
        {
            if (__instance == null || SledgepinPlugin.Instance == null)
                return;
            SledgepinPlugin.Instance.StartBootstrap(__instance);
        }
    }
    ...
    internal static class BlueprinterGate
    {
        ...
        internal static IEnumerator WaitUntilReady()
        {
            ...
            SledgepinPlugin.ModLog?.LogWarning("Blueprinter ApplyAllOps timeout — continuing bootstrap.");
        }
    }
}
