namespace Sledgepin
{
    internal static class SledgepinConstants
    {
        public const string MissileJsonKey = "missilepack_agr75sledgepin";
        public const string MountKeyPrefix = "MissilePack_AGR75Sledgepin_";
        public const string MountJsonKey4x = "MissilePack_AGR75Sledgepin_4x";
        public const string MountJsonKey6x = "MissilePack_AGR75Sledgepin_6x";
        public const string WeaponInfoName = "AGR-75 Sledgepin";
        public const string MountDisplayName = "AGR-75 Sledgepin";
        public const string UnitName = "AGR-75 Sledgepin";
        public const string ShortName = "Sledgepin";
        public const string BogeyName = "AGR-75 Sledgepin";
        public const string SeekerTypeName = "Laser";
        public const string Description =
            "Heavy laser-guided air-to-ground rocket (Sledgepin). 16kg HE, high AP, long burn then IR-cold coast. ~15-20km from air launch.";

        public const string RocketVisualName = "SledgepinRocket";
        public const string LauncherVisualName = "SledgepinLauncher";
        public const string LauncherEmbeddedRocketName = "Rocket";
        public const string BundleModName = "AGR75Sledgepin";
        public const string NobpFileName = "AGR75Sledgepin.nobp";
        public const string PreviewIconFileName = "AGR-Preview.png";
        public const string PreviewIconResource = "Sledgepin.Resources.AGR-Preview.png";
        ...
        // Blender axis fix: launcher root + fly SledgepinRocket (embedded rockets inherit launcher yaw).
