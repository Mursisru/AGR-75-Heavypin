    ...
    internal static class AgrDonor
    {
        internal static bool IsAgr24Name(string? s)
        {
            if (string.IsNullOrEmpty(s))
                return false;
            return s!.IndexOf(HeavypinConstants.Agr24Name, StringComparison.OrdinalIgnoreCase) >= 0 ||
                   s.IndexOf(HeavypinConstants.Agr24Alt, StringComparison.OrdinalIgnoreCase) >= 0;
        }
        ...
        internal static bool IsAgr18Name(string? s)
        {
            if (string.IsNullOrEmpty(s))
                return false;
            return s!.IndexOf(HeavypinConstants.Agr18Name, StringComparison.OrdinalIgnoreCase) >= 0 ||
                   s.IndexOf(HeavypinConstants.Agr18Alt, StringComparison.OrdinalIgnoreCase) >= 0;
        }
        ...
        internal static bool IsSmallAgrSlot(WeaponMount mount)
        {
            ...
            return ammo > 0 && ammo <= HeavypinConstants.SmallAmmoMax;
        }

        internal static bool IsLargeAgrSlot(WeaponMount mount)
        {
            int ammo = CountAmmo(mount);
            return ammo > HeavypinConstants.SmallAmmoMax;
        }
