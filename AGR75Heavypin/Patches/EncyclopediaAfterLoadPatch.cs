...
namespace Heavypin.Patches
{
    ...
    internal static class EncyclopediaAfterLoadPatch
    {
        ...
        {
            if (__instance == null || HeavypinPlugin.Instance == null)
                return;
            HeavypinPlugin.Instance.StartBootstrap(__instance);
        }
    }
    ...
    internal static class BlueprinterGate
    {
        internal static IEnumerator WaitUntilReady()
        {
            ...
            HeavypinPlugin.ModLog?.LogWarning("Blueprinter PatchingComplete timeout — continuing bootstrap.");
        }
    }
}
